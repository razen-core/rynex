...
import { ElementBuilder, TextBuilder, ButtonBuilder, InputBuilder, ImageBuilder } from './builder.js';
...
// Legacy support
export function divLegacy(props: DOMProps, ...children: DOMChildren[]): HTMLElement {
...
// Legacy support
export function spanLegacy(props: DOMProps, ...children: DOMChildren[]): HTMLElement {
...
// Legacy support
export function textLegacy(props: DOMProps | string | (() => string), content?: string | (() => string)): HTMLElement {
...
// Legacy support
export function buttonLegacy(props: DOMProps, content?: string | (() => string) | DOMChildren[]): HTMLElement {
...
// Legacy support
export function imageLegacy(props: DOMProps & { src: string; alt?: string; lazy?: boolean }): HTMLImageElement {
...
// Legacy support
export function linkLegacy(props: DOMProps & { href: string }, ...children: DOMChildren[]): HTMLAnchorElement {
...
// Legacy support
export function labelLegacy(props: DOMProps & { htmlFor?: string }, ...content: DOMChildren[]): HTMLLabelElement {
...
// Legacy support
export function pLegacy(props: DOMProps, ...content: DOMChildren[]): HTMLParagraphElement {
...
// Legacy support
export function ulLegacy(props: DOMProps, ...children: DOMChildren[]): HTMLUListElement {
  return createElement('ul', props, ...children) as HTMLUListElement;
}

export function olLegacy(props: DOMProps, ...children: DOMChildren[]): HTMLOListElement {
  return createElement('ol', props, ...children) as HTMLOListElement;
}

export function liLegacy(props: DOMProps, ...content: DOMChildren[]): HTMLLIElement {
...
// Legacy support
export function dlLegacy(props: DOMProps, ...children: DOMChildren[]): HTMLDListElement {
  return createElement('dl', props, ...children) as HTMLDListElement;
}

export function dtLegacy(props: DOMProps, ...content: DOMChildren[]): HTMLElement {
  return createElement('dt', props, ...content);
}

export function ddLegacy(props: DOMProps, ...content: DOMChildren[]): HTMLElement {
