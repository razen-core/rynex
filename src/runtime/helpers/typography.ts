...
export function blockquoteLegacy(
  props: DOMProps,
...
export function abbrLegacy(
  props: DOMProps & { title: string },
  ...content: DOMChildren[]
): HTMLElement {
  return createElement("abbr", props, ...content);
}

export function citeLegacy(
  props: DOMProps,
  ...content: DOMChildren[]
): HTMLElement {
...
export function varElementLegacy(
  props: DOMProps,
  ...content: DOMChildren[]
): HTMLElement {
