 ...
 */
export function generateRouteManifest(manifest: RouteManifest, outputPath: string): void {
  const code = `/**
 ...
 */
export function generateRouterConfig(manifest: RouteManifest, outputPath: string): void {
