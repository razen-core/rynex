...
export function validateHTML(
  ...
  const openTags =
    html.match(/<(html|head|body|div|script|style)[^>]*>/gi) || [];
 ...
 */
export function validateHTMLDirectory(
  dir: string,
  autoFix: boolean = false,
): Map<string, HTMLValidationResult> {
...
export function printValidationResults(
  results: Map<string, HTMLValidationResult>,
): void {
  let totalIssues = 0;
  let totalFixed = 0;
